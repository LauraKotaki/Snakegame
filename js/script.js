...
document.addEventListener('keydown', update); //criação do evento ao aperta a tecla "para baixo"
...
function iniciarjogo() {
    ...
    if (snake[0].y < 0 && direction == "up") snake = 16 * box;
